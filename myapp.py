...
st.set_page_config(
    page_title='Analytics Portal by Kuldeep', #set configuaration for our application's title
    page_icon='📊'
)
#application title
...
if(file!=None):
    ...
    st.subheader(':gray[Basic information of the dataset]',divider='rainbow')
    ...
    st.subheader(':gray[Column Values To Count]',divider='rainbow')
    ...
    st.subheader(':gray[Groupby: Simplify your data analysis]',divider='rainbow')
    st.write('The groupby lets you summarize data by specific categories and group')
    with st.expander('Group By your columns'):
        ...
        if(groupby_cols):
            ...
            st.subheader(':gray[Data Visualization]',divider='rainbow')
            ...
            if(graphs=='Line'):
                ...
                values = st.selectbox('Choose Numericl Values',options=list(result.columns))
